...
<div class="modal fade" id="editTopicModal" tabindex="-1" role="dialog" aria-labelledby="editTopicLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <form method="post" action="{{ route('topic.update') }}" enctype="multipart/form-data"
                          autocomplete="off">
                        @csrf
                        @method('put')
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                <input type="text" name="id" id="topic_id" readonly hidden >

                                <label class="form-control-label"
                                       for="name">{{ __('Title') }}</label>
                                <div class="input-group">
                                    <input type="text" name="title" id="modalTopicTitle"
                        ...
                        <div class="form-row justify-content-center">
                            <img id="modal-topic-image-preview" style="max-width: 80%" src=""
                        ...
                        <div class="form-group ">
                            <div class="input-group mt-1 mb-3 ">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="modalTopicImage">Image</span>
                                </div>
        ...
        function readImgURL(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('#modal-topic-image-preview').attr('src', e.target.result);
                }

                reader.readAsDataURL(input.files[0]);
            }
            else {
                $('#modal-topic-image-preview').attr('src', localStorage.getItem('topicImage'));
            }
        }
    </script>
</div>